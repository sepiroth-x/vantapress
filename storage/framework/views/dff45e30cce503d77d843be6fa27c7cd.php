        ...
        <div class="lg:col-span-1 overflow-y-auto pr-4 customizer-panel">
            <div class="space-y-6">
                <div class="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                    <h3 class="text-lg font-semibold mb-2">Theme: <?php echo e($record->name); ?></h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($record->description); ?></p>
...
<?php endif; ?>
<?php /**PATH C:\Users\sepirothx\Documents\3. Laravel Development\vantapress\resources\views/filament/resources/theme-resource/pages/customize-theme.blade.php ENDPATH**/ ?>