            ...
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-white">
                        VantaPress <?php echo e($currentVersion); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['wire:click' => 'checkForUpdates','wire:loading.attr' => 'disabled','icon' => 'heroicon-o-arrow-path','color' => 'gray']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'checkForUpdates','wire:loading.attr' => 'disabled','icon' => 'heroicon-o-arrow-path','color' => 'gray']); ?>
...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($latestRelease): ?>
            <?php if (isset($component)) { $__componentOriginalee08b1367eba38734199cf7829b1d1e9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalee08b1367eba38734199cf7829b1d1e9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.section.index','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::section'); ?>
...
<?php $component->withAttributes([]); ?>
                 <?php $__env->slot('heading', null, []); ?> 
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($updateAvailable): ?>
                ...
                <div class="space-y-4">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3 flex-1">
                                    <h3 class="text-lg font-medium text-green-800 dark:text-green-200">
                                        Version <?php echo e($latestRelease['version']); ?> Available
                                    </h3>
                                    <p class="mt-1 text-sm text-green-700 dark:text-green-300">
                                        Released <?php echo e(\Carbon\Carbon::parse($latestRelease['published_at'])->diffForHumans()); ?>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-4 flex-1">
                                    ...
                                    <p class="text-base text-green-700 dark:text-green-300 font-medium">
                                        You're running VantaPress v<?php echo e($currentVersion); ?> - the most current release available.
                                    </p>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="rounded-lg border border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-800">
                            <div class="prose prose-sm dark:prose-invert max-w-none
                                ...
                                <?php echo \Illuminate\Mail\Markdown::parse($latestRelease['body']); ?>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 mt-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($updateAvailable): ?>
                            <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['wire:click' => 'installUpdate','wire:loading.attr' => 'disabled','icon' => 'heroicon-o-arrow-down-circle','color' => 'success','size' => 'lg','class' => 'w-full sm:w-auto justify-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'installUpdate','wire:loading.attr' => 'disabled','icon' => 'heroicon-o-arrow-down-circle','color' => 'success','size' => 'lg','class' => 'w-full sm:w-auto justify-center']); ?>
...
<?php endif; ?>
                        ...
                        <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['wire:click' => 'viewReleaseNotes','icon' => 'heroicon-o-document-text','color' => 'primary','size' => 'lg','tag' => 'a','href' => ''.e($latestRelease['html_url']).'','target' => '_blank','class' => 'w-full sm:w-auto justify-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'viewReleaseNotes','icon' => 'heroicon-o-document-text','color' => 'primary','size' => 'lg','tag' => 'a','href' => ''.e($latestRelease['html_url']).'','target' => '_blank','class' => 'w-full sm:w-auto justify-center']); ?>
...
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($updateAvailable && $latestRelease['zipball_url']): ?>
                            <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['icon' => 'heroicon-o-arrow-down-tray','color' => 'gray','size' => 'lg','tag' => 'a','href' => ''.e($latestRelease['zipball_url']).'','target' => '_blank','class' => 'w-full sm:w-auto justify-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'heroicon-o-arrow-down-tray','color' => 'gray','size' => 'lg','tag' => 'a','href' => ''.e($latestRelease['zipball_url']).'','target' => '_blank','class' => 'w-full sm:w-auto justify-center']); ?>
                                Download Manually
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6330f08526bbb3ce2a0da37da512a11f)): ?>
...
<?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($updateProgress): ?>
                        <div class="mt-6 space-y-3">
                            <h4 class="text-sm font-medium text-gray-900 dark:text-white">Update Progress:</h4>
                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $updateProgress['steps']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-start space-x-3 p-3 rounded-lg <?php echo e($step['success'] ? 'bg-green-50 dark:bg-green-900/20' : 'bg-red-50 dark:bg-red-900/20'); ?> border <?php echo e($step['success'] ? 'border-green-200 dark:border-green-800' : 'border-red-200 dark:border-red-800'); ?>">
                                    <span class="text-lg">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-sm font-medium <?php echo e($step['success'] ? 'text-green-800 dark:text-green-200' : 'text-red-800 dark:text-red-200'); ?>">
                                            Step <?php echo e($index + 1); ?>: <?php echo e($step['message']); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($updateProgress['success']): ?>
...
<?php $component->withAttributes([]); ?>
            ...
            <div class="flex items-center justify-between">
                ...
                <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['icon' => 'heroicon-o-arrow-top-right-on-square','color' => 'gray','tag' => 'a','href' => 'https://github.com/sepiroth-x/vantapress','target' => '_blank']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'heroicon-o-arrow-top-right-on-square','color' => 'gray','tag' => 'a','href' => 'https://github.com/sepiroth-x/vantapress','target' => '_blank']); ?>
                    View on GitHub
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6330f08526bbb3ce2a0da37da512a11f)): ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\sepirothx\Documents\3. Laravel Development\vantapress\resources\views/filament/pages/update-system.blade.php ENDPATH**/ ?>