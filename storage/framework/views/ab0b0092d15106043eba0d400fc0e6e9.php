    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-4">
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                VantaPress v<?php echo e(config('version.version', '1.0.21-complete')); ?> • WordPress Philosophy, Laravel Power
            </p>
        </div>
        ...
        <div class="mt-4 pt-4 border-t border-gray-100 dark:border-gray-800 text-center">
            <p class="text-xs text-gray-500 dark:text-gray-500">
                Copyright © <?php echo e(date('Y')); ?> Richard Cebel Cupal (Xenroth Vantablack). Licensed under MIT. 
...
<?php /**PATH D:\0. Web Development\4. Laravel Development\vantapress-1.0.13-complete\resources\views/filament/footer.blade.php ENDPATH**/ ?>