...
<section class="villain-hero relative overflow-hidden">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($heroConfig['background_type'] === 'image' && !empty($heroConfig['background_image'])): ?>
        <div class="absolute inset-0 z-0">
            <img src="<?php echo e(asset($heroConfig['background_image'])); ?>" 
                 alt="Hero Background" 
    ...
    <div class="relative z-10 container mx-auto px-4 py-32">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="text-2xl md:text-3xl text-gray-300 mb-6 font-light">
                <?php echo e($heroConfig['subtitle']); ?>

            </p>
            
            
            <p class="text-lg text-gray-400 mb-10 max-w-2xl mx-auto leading-relaxed">
                <?php echo e($heroConfig['description']); ?>

            </p>
            
            
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($heroConfig['show_cta']): ?>
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <a href="<?php echo e($heroConfig['cta_primary_url']); ?>" 
                       class="group relative px-8 py-4 bg-villain-600 hover:bg-villain-700 text-white font-bold rounded-lg 
                        ...
                        <span class="relative z-10"><?php echo e($heroConfig['cta_primary_text']); ?></span>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($heroConfig['cta_secondary_text'])): ?>
                        <a href="<?php echo e($heroConfig['cta_secondary_url']); ?>" 
                           class="px-8 py-4 border-2 border-villain-600 hover:border-villain-500 text-villain-500 hover:text-villain-400 
                            ...
                            <?php echo e($heroConfig['cta_secondary_text']); ?>
...
<?php /**PATH C:\Users\sepirothx\Documents\3. Laravel Development\vantapress\themes/TheVillainArise/components/hero.blade.php ENDPATH**/ ?>