...
class CommandRegistry
{
     ...
     * 
     * @param string $name Command name (must start with 'vanta-')
    ...
    {
        // Enforce vanta-* prefix
        if (!str_starts_with($name, 'vanta-')) {
            Log::warning("[Villain Terminal] Command '{$name}' rejected - must start with 'vanta-'");
            return;
        }
