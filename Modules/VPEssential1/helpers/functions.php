...
if (!function_exists('vp_get_hero_config')) {
    ...
    function vp_get_hero_config(): array
    {
        return [
            ...
            'cta_primary_url' => vp_get_theme_setting('hero_cta_primary_url', 'https://github.com/sepiroth-x/vantapress'),
            'cta_secondary_text' => vp_get_theme_setting('hero_cta_secondary_text', 'View Docs'),
            'cta_secondary_url' => vp_get_theme_setting('hero_cta_secondary_url', 'https://github.com/sepiroth-x/vantapress#readme'),
