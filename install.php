    ...
    <div class="container">
        ...
        elseif ($step === 6) {
            ...
            try {
                ...
                // Dispatch installation complete event for telemetry
                if (class_exists('Illuminate\Support\Facades\Event')) {
                    \Illuminate\Support\Facades\Event::dispatch('vantapress.installed');
                    echo "<!-- Telemetry: Installation event dispatched -->\n";
                }
            } catch (Exception $e) {
                echo "<!-- Telemetry event error (non-critical): " . htmlspecialchars($e->getMessage()) . " -->\n";
            }
            ?>
            <div class="content-area">
            <div class="step">
